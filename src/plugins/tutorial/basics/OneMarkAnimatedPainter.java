...
/**
 * \page tuto8 Tutorial: Fancy animated painters
 * 
 * Fancy mark to demonstrate the capabilities of painters.

 * \code
 * 
 * public class OneMarkAnimatedPainter extends AbstractPainter implements ActionListener
{
    ...
    public OneMarkAnimatedPainter(Sequence sequence, Point2D imagePoint)
    {
    ...
    public void paint(Graphics2D g, Sequence sequence, IcyCanvas canvas)
    {
        ...
        for (int i = 0; i < text.length(); i++)
        {
            ...
            // This lead to a memory leak, due to a bug in the JVM 1.6 cache of transformed fonts. (bug reported)
